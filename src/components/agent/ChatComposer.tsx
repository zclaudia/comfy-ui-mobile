...
export function ChatComposer({ value, onChange, disabled, placeholder, attachments, onAddFiles, onPickFromLibrary, onRemoveAttachment, onRetryAttachment, canSend, onSend }: {
