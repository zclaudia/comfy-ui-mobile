...
export interface AgentSession {
  id: string; name: string; version: number; created: number; workflow?: SessionWorkflowRef; previewPolicy?: PreviewPolicy;
  preview?: string; lastMessage?: string; lastActivity?: number; active?: boolean; lastState?: string; thumbnail?: AgentMediaRef & { kind?: 'image' | 'video' | 'audio' };
}
...
export type SessionPatch = { name?: string; workflow?: SessionWorkflowRef | null; previewPolicy?: PreviewPolicy };
