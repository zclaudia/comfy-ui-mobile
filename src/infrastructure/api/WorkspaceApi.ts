...
export class WorkspaceApi extends AgentTransport {
  ...
  legacyVersion(id: string, version: number, signal?: AbortSignal) { return this.request<{ reference: { draftId: string; revision: number }; revision: Revision; readOnly: true }>(`${sessionPath(id)}/versions/${version}`, {}, signal); }
